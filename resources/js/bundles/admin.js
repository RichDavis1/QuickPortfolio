...
$(document).ready(function(){  
        ...
        $.ajax({            
            ...
            success: function (data) { 
                if(data.result == 'success'){
                    ...
                    $("#deleteProjectModal").modal('show').css('display', 'block');	                  
                }
            }
        });        
    });    
        ...
        $.ajax({            
            ...
            success: function (data) { 
                if(data.result == 'success'){
                    ...
                    $("#deleteProjectModal").modal('hide').css('display', 'none');	                    
                }
            }
        });        
    });        
    ...
    $(document).on('click', '.save-field', function(){
        ...
        $.ajax({            
            ...
            success: function (data) { 
                ...
                if(data.result == 'success'){
                    updateFieldContent(data.field, data.value);
                    $("#admin-settings").empty().append(data.view);
    ...
    function updateFieldContent(field, content){
        if(field == 'website_name'){
            $("#site-logo").empty().append(content);
            return;
        }else if(field == 'github_link'){
            $("#head-ghl").attr('href', content);
            return;
            ...
            if($("#head-ll").length){
                $("#head-li").attr('href', content);
                return;
            }
        
            var linkWrap = "<a href='"+content+"' id='head-ll' target='_blank'><div class='header-icon linkedin-grey'></div></a>";
            $("#head-links").append(linkWrap);            
        }
    }
